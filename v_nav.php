<nav>
    <div class="boutonMenu"><div class="titreMenu">gestion des emprunts</div>
        ...
        <a class="SousMenu" href="Emprunt_show.php">Afficher/editer/supprimer des emprunts</a>
    ...
    <div class="boutonMenu"><div class="titreMenu">gestion des oeuvres et auteurs</div>
        <a class="SousMenu" href="Oeuvre_show.php">afficher/editer/supprimer des Oeuvres</a>
